...
export class LayoutComponent {
  ...
  navItems = [
    ...
    { path: '/roles', label: 'Roles', icon: 'badge' },
    { path: '/registros', label: 'Registros', icon: 'schedule' },
  ...
  getIconSvg(icon: string): string {
    const icons: Record<string, string> = {
      ...
      badge: '<path d="M20 6h-4V4c0-1.11-.89-2-2-2h-4c-1.11 0-2 .89-2 2v2H4c-1.11 0-1.99.89-1.99 2L2 19c0 1.11.89 2 2 2h16c1.11 0 2-.89 2-2V8c0-1.11-.89-2-2-2zm-6 0h-4V4h4v2z"/>',
      ...
      calculator: '<path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-5 14H7v-2h7v2zm3-4H7v-2h10v2zm0-4H7V7h10v2z"/>',
